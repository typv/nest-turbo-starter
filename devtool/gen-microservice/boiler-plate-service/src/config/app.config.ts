...
export const getAppConfig = () => ({
  appName: process.env.BOILER_PLATE_SERVICE_APP_NAME,
  appPort: +process.env.BOILER_PLATE_SERVICE_APP_PORT || 3302,
  microserviceName: MicroserviceName.UserService,
  queueDashboardPassword:
    process.env.BOILER_PLATE_SERVICE_QUEUE_DASHBOARD_PASSWORD ||
